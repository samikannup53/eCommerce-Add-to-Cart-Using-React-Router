  ...
  return (
    <section className="p-6 bg-gradient-to-t from-[rgba(217,236,255,2)] to-[rgba(240,243,255,0)]">
      <div className=" container mx-auto flex flex-col items-center md:gap-6 my-10 cursor-default relative ">
        ...
        <img src={circleImage} alt="" className="absolute -bottom-15 sm:-bottom-6 right-4 sm:right-10" />
        <img src={semiCircleImage} alt="" className="absolute -top-10  sm:-top-5 -left-4 sm:left-10" />
        <img src={triangleImage} alt="" className="animate-pulse absolute bottom-10 left-20 lg:left-60 hidden sm:block" />
        <img src={triangleImage} alt="" className="animate-pulse absolute top-2 right-10 lg:right-40 hidden sm:block" />
      </div>
    </section>
  );
};
