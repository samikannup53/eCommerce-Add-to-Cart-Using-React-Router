        ...
        {cart.length === 0 ? (
          ...
          <div className="pb-6 gap-4 flex flex-col-reverse sm:flex-row-reverse justify-between items-start">
            ...
            <div className="flex-3/4 bg-white shadow-md rounded-sm">
              ...
              <div className="text-center border-t-[1px] border-gray-300 p-5 2xl:p-8 flex flex-col sm:flex-row gap-4 justify-end sticky bottom-0 bg-white drop-shadow-lg">
              <Link
                  ...
                  class="text-lg bg-[#fb641b] px-6 py-2 rounded-[6px] hover:bg-[#2455f4] font-medium text-white cursor-pointer"
                >
                  CLEAR CART
                </Link>
